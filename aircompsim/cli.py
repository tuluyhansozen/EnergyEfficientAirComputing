...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog="aircompsim",
        description="Energy-Efficient Air Computing Simulator"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1000,
        help="Simulation time limit (default: 1000)"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Number of edge servers (default: 4)"
    )
    
    parser.add_argument(
        "--drl",
        action="store_true",
        help="Enable DRL training"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=500,
        help="Number of DRL episodes (default: 500)"
    )
