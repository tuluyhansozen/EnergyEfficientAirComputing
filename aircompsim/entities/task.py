...
ENTERTAINMENT_APP = ApplicationType(
    name="Entertainment", cpu_cycle=100, worst_delay=0.3, best_delay=0.1, interarrival_time=10
)

MULTIMEDIA_APP = ApplicationType(
    name="Multimedia", cpu_cycle=100, worst_delay=3.0, best_delay=0.1, interarrival_time=10
)

RENDERING_APP = ApplicationType(
    name="Rendering", cpu_cycle=200, worst_delay=1.0, best_delay=0.5, interarrival_time=20
)

IMAGE_CLASSIFICATION_APP = ApplicationType(
    name="ImageClassification", cpu_cycle=600, worst_delay=1.0, best_delay=0.5, interarrival_time=20
)
...
class Application:
    ...
    def compute_qos(self, warmup_period: float = 100.0) -> float:
        ...
        """
        completed_tasks = [t for t in self.tasks if t.creation_time > warmup_period and t.qos >= 0]
